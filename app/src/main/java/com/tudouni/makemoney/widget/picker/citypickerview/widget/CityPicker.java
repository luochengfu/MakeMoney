package com.tudouni.makemoney.widget.picker.citypickerview.widget;
...
import com.tudouni.makemoney.widget.picker.citypickerview.model.CityModel;
import com.tudouni.makemoney.widget.picker.citypickerview.model.DistrictModel;
import com.tudouni.makemoney.widget.picker.citypickerview.model.ProvinceModel;
import com.tudouni.makemoney.widget.picker.citypickerview.utils.XmlParserHandler;
import com.tudouni.makemoney.widget.picker.citypickerview.widget.wheel.OnWheelChangedListener;
import com.tudouni.makemoney.widget.picker.citypickerview.widget.wheel.WheelView;
import com.tudouni.makemoney.widget.picker.citypickerview.widget.wheel.adapters.ArrayWheelAdapter;
...
public class CityPicker implements CanShow, OnWheelChangedListener {
     ...
     * 设置popwindow的背景
     */
    private int backgroundPop = 0x00000000;
    ...
    private CityPicker(Builder builder) {
        ...
        root = popview.findViewById(R.id.ll_qr);
        root.setBackgroundColor(backgroundPop);
//        popwindow.setAnimationStyle(R.style.AnimBottom);
        popwindow=new Dialog(context,R.style.my_dialog2);
        popwindow.setContentView(popview);
        WindowManager.LayoutParams lp = popwindow.getWindow().getAttributes();
        DisplayMetrics d = context.getResources().getDisplayMetrics();
        lp.width = WindowManager.LayoutParams.MATCH_PARENT;
        lp.height = WindowManager.LayoutParams.WRAP_CONTENT;
        lp.gravity = Gravity.BOTTOM;
        popwindow.getWindow().setAttributes(lp);
...
//            startTranslation();
    ...
    private void startTranslation() {
        int colorB = Color.argb(127,0,0,0);
        ObjectAnimator objectAnimator = ObjectAnimator.ofInt(root,"backgroundColor",colorB);
