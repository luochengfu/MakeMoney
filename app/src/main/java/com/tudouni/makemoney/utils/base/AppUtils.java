...
public final class AppUtils {
    ...
    public static void installApp(File file, String authority) {
        ...
        BaseViewHelper.getInstance().getApplicationContext().startActivity(IntentUtils.getInstallAppIntent(file, authority));
    }
    ...
    public static void uninstallApp(String packageName) {
        ...
        BaseViewHelper.getInstance().getApplicationContext().startActivity(IntentUtils.getUninstallAppIntent(packageName));
    }
    ...
    public static void launchApp(String packageName) {
        if (isSpace(packageName)) return;
        BaseViewHelper.getInstance().getApplicationContext().startActivity(IntentUtils.getLaunchAppIntent(packageName));
    }
    ...
    public static String getAppPackageName() {
        return BaseViewHelper.getInstance().getApplicationContext().getPackageName();
    }
    ...
    public static void getAppDetailsSettings() {
        getAppDetailsSettings(BaseViewHelper.getInstance().getApplicationContext().getPackageName());
    }
    ...
    public static void getAppDetailsSettings(String packageName) {
        if (isSpace(packageName)) return;
        BaseViewHelper.getInstance().getApplicationContext().startActivity(IntentUtils.getAppDetailsSettingsIntent(packageName));
    }
    ...
    public static String getAppName() {
        return getAppName(BaseViewHelper.getInstance().getApplicationContext().getPackageName());
    }
    ...
    public static String getAppName(String packageName) {
        ...
        try {
            PackageManager pm = BaseViewHelper.getInstance().getApplicationContext().getPackageManager();
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(BaseViewHelper.getInstance().getApplicationContext().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(BaseViewHelper.getInstance().getApplicationContext().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(BaseViewHelper.getInstance().getApplicationContext().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(BaseViewHelper.getInstance().getApplicationContext().getPackageName());
    }
    ...
    public static boolean isSystemApp() {
        return isSystemApp(BaseViewHelper.getInstance().getApplicationContext().getPackageName());
    }
    ...
    public static boolean isAppDebug() {
        return isAppDebug(BaseViewHelper.getInstance().getApplicationContext().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(BaseViewHelper.getInstance().getApplicationContext().getPackageName());
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(BaseViewHelper.getInstance().getApplicationContext().getPackageName());
    }
    ...
    public static String getAppPackageName(Context context) {
        ...
        try {
            ...
            TuDouLogUtils.e("VersionInfo", e.getMessage());
        }
