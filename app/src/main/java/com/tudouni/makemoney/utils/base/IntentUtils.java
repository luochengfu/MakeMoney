...
public final class IntentUtils {
    ...
    public static Intent getInstallAppIntent(File file, String authority) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            data = FileProvider.getUriForFile(BaseViewHelper.getInstance().getApplicationContext(), authority, file);
        }
    ...
    public static Intent getLaunchAppIntent(String packageName) {
        return BaseViewHelper.getInstance().getApplicationContext().getPackageManager().getLaunchIntentForPackage(packageName);
    }
