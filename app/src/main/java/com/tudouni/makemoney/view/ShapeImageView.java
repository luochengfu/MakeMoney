...
public class ShapeImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    private int DEFAULT_SHAPE = 1;       // 默认形状
    ...
    public ShapeImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TuDouLogUtils.i("debug", "ShapeImageView");
...
//        super.onDraw(canvas);   // 不需要调用父类ImageView中的onDraw方法，否则原始图片也会显示
    ...
    public void setImageResource(int resId) {
        ...
        TuDouLogUtils.i("debug", "setImageResource");
        if (resId != 0) {
            try {
    ...
    public void setImageBitmap(Bitmap bm) {
        ...
        TuDouLogUtils.i("debug", "setImageBitmap");
        if (bm == null) {
            return;
        }
        this.bitmap = bm;
    ...
    public void setImageDrawable(Drawable drawable) {
        ...
        TuDouLogUtils.i("debug", "setImageDrawable");
    ...
    private void preDraw() {
        ...
        TuDouLogUtils.i("debug", "circleRadius = " + circleRadius);
