...
/**
 * Created by zhangjiajie on 2017/10/15.
 */

public class PullToRefreshBridgeWebView extends PullToRefreshBase<BridgeWebView> {

    private static final OnRefreshListener<BridgeWebView> defaultOnRefreshListener = new OnRefreshListener<BridgeWebView>() {
    ...
    public PullToRefreshBridgeWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public PullToRefreshBridgeWebView(Context context, Mode mode, AnimationStyle style) {
    ...
    @TargetApi(9)
    final class InternalWebViewSDK9 extends BridgeWebView {
        ...
        protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX,
            ...
            OverscrollHelper.overScrollBy(PullToRefreshBridgeWebView.this, deltaX, scrollX, deltaY, scrollY,
